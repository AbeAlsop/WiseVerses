...
def get_virtue(text, context = []):
    messages = [
        ...
        For example, if someone is going on a vacation, then this is related to "Journey". If the user is calling himself stupid, this is related to "Self-respect". Questions about marriage are related to "Love", and questions about raising children are related to "Parenting". 
