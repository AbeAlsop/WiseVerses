...
def get_notification(personal, name=None, day=None, location=None):
    if day is None:
    ...
    context = [personal_context, news_headlines] + ([weather] if weather is not None else [])
    print(context)
    ...
    return {"notification": notification, "url": url}
...
if __name__ == "__main__":
    ...
    response = get_notification(personal, name, day, location)
